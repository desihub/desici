...
PROGNAME = 'ZBFplot2.py'

infile = 'ZBF5fwd_Nrings_8_Rmax_28.txt'
plotfile = 'ZBFplot2.png'
...
LUT = [3,4,8,9]  #ignore translations, magnification, and InOut
nplots = len(LUT)
...
# for icoef in icoefs:
    icoef = LUT[i]
    coefs = myArray[0:nrows, icoef]
    plt.plot(angles, coefs, color=colors[i])
    ax.text(0.02, 0.90-0.03*i, names[icoef], color=colors[i], \

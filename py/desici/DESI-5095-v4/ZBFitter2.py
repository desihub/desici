...
# ZBFitter2.py
#
# Here using radial scaling factors RMAX=27mrad,  FPMAX=390mm
#
# Results for ADC=00, forward, 11 ZB coefs:
...
# Results for ADC=00, reverse, 11 ZB coefs:
#   -0.000023   -0.000002    0.012965    0.000001   -0.000010   -0.018778    0.000475    0.000000    0.000005   -0.000001    0.000000   
#
...
FPMAX     = 390    # millimeters


# first get the forward (sky to FP) fits to the 24 ADC tasks

outfilename = 'ZBF2fwd_Nrings_' + str(NRINGS) + '_Rmax_' + str(RMAX) + '.txt'
...
outfilename = 'ZBF2rev_Nrings_' + str(NRINGS) + '_Rmax_' + str(RMAX) + '.txt'

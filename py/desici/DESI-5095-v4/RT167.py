#  RT167.py  MLL UCB SSL July 2019
...
tasks = np.array([[   0.0,    0.0],       # ADC1, ADC2 angles at zenith
                  ...
                  [   0.0,  300.0],
                  [   0.0,  330.0],
                  [   0.0,    0.0    dx0 = myArray[i*5+f, 5] - myArray[i*5+g, 5]])               
                  
NRINGS = 8
RMAX = 27 # milliradians

uvpairs = np.array([[ 0.000,   0.000],
                    [ 0.027,   0.000],
                    [ 0.000,   0.027],
                    [-0.027,   0.000],
                    [ 0.000,  -0.027]])
...
outfilename = 'RT167_Nfields_5_Rmax_27.txt'

...
colors = ['red', 'blue', 'green', 'black', 'cyan', 'magenta', 'gray', 'tab:purple']
...
for j in range(8):  # eight diagnostic distances to plot
    ...
    plt.plot(angles, distdiffs, colors[j])

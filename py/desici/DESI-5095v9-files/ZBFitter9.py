...
# ZBFitter9.py
#
# Fixes sign error in "T8" generator >>THANK YOU STEVE KENT<<
#
# Fits ZB distortion model to each of 25 ADC states. 
# using 1ppm added noise to eliminate any fit singularities.  Works. 
# M.Lampton UCB SSL  27 July 2019
...
def getZhaoBurgeTerm(whichparm, x, y):
    # Given a Lampton index "which" 0....32 and an object point x, y,
...
outfilename = 'ZBF9fwd_Nrings_' + str(NRINGS) + '_Rmax_' + str(UVMAX) + '.txt'
...
outfilename = 'ZBF9rev_Nrings_' + str(NRINGS) + '_Rmax_' + str(UVMAX) + '.txt'

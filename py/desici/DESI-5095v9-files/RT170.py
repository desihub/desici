#  RT170.py  MLL UCB SSL July 2019
#
...
tasks = np.array([[   0.0,    0.0],      # ADC1, ADC2 angles at zenith
                  [  30.0,    0.0],
                  [  60.0,    0.0],                  
                  [  90.0,    0.0],
                  [ 120.0,    0.0],
...
uvpairs = getHexagonalNumbers(NRINGS, 0.001*UVMAX) # fills the FOV with 217 stars
noext = PROGNAME.rsplit('.',1)[0]    
outfilename = noext + '_Nrings_' + str(NRINGS) + '_Rmax_' + str(UVMAX) + '.txt'

"""
uvpairs = np.array([[  0.000,  0.000 ],  # fills FOV with the "northern Cross"
                    [  0.027,  0.000 ],
                    [  0.000,  0.027 ],
                    [ -0.027,  0.000 ],
                    [  0.000, -0.027 ]])                   
outfilename = 'RT170_Nstars_5_Rmax_27.txt'
"""
